...
[![Maven Central](https://img.shields.io/maven-central/v/io.mockative.krouton/mockative)](https://search.maven.org/artifact/io.mockative.krouton/mockative)
...
kotlin {
    sourceSets {
        val commonTest by getting {
            dependencies {
                implementation("io.mockative.krouton:mockative:1.1.4")
            }
        }
    }
}
...
dependencies {
    ksp("io.mockative.krouton:mockative-processor:1.1.4")
}
```
